...
import jigutory from '../image/jigu-logo.png';
import kakao from '../image/kakao-ch.png';
...
const Footer = () => {
  return (
    <div className="footer-container">
      <section>
        <div> <img className="jigutory-logo" src={jigutory} alt="jigutory-logo" /> </div>
      ...
      <section className="footer-links">
        <h3><img className="github-logo" src={github} alt="move to github" /> Contact Us</h3>
