...
function Map() {
  ...
  const searchMarkers = () => {
    ...
    const position = new kakao.maps.LatLng(searchLatLng[0], searchLatLng[1]);

    const image = new kakao.maps.MarkerImage(
      `/images/marker/search-marker.gif`,
      new kakao.maps.Size(40, 70),
      { offset: new kakao.maps.Point(22, 70) },
    );
  ...
  //     handleSearchLatLng(y, x);
  //     setSearchMode(false);
  //     setSearchLatLng([y, x]);
  //   }
  // };

  // // 검색 리스트 중 하나 클릭하면 좌표 이동
  // const handleSearchListClick = (y, x) => {
  //   handleSearchLatLng(y, x);
  //   setSearchMode(false);
  //   setSearchLatLng([y, x]);
  // };
